...
fig.savefig(os.path.dirname(__file__) + "/data/modified_ensemble_single.pdf", bbox_inches="tight", dpi=300)
...
fig.savefig(os.path.dirname(__file__) + "/data/modified_ensemble.pdf", bbox_inches="tight",dpi=300)
